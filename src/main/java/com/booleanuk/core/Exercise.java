...
public class Exercise extends ExerciseBase {
    ...
    public ArrayList<Integer> multiply(ArrayList<Integer> numbers, int factor) {
        for (int i = 0; i < numbers.size(); i++) {
            int original = numbers.get(i);
            numbers.set(i, original * factor);
        }
        return numbers;
    }
    ...
    public boolean isEmpty(ArrayList<String> str) {
        return str.size() == 0;
    }
