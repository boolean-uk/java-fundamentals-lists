...
public class Exercise extends ExerciseBase {
     ...
     */
    public ArrayList<String> addIngredient(ArrayList<String> lst, String str) {
        lst.add(str);
        return lst;
    }
     ...
     */
    public ArrayList<String> removeIngredient(ArrayList<String> lst, String str) {
        lst.remove(str);
        return lst;
    }
    ...
    public boolean containsIngredient(ArrayList<String> lst, String str) {
