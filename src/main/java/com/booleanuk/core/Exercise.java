...
public class Exercise extends ExerciseBase {
     ...
     */
    public ArrayList<Integer> multiply(ArrayList<Integer> intList, int num) {
        intList.replaceAll(i -> i*num);
        return intList;
    }
     ...
     */
    public ArrayList<String> addIngredient(ArrayList<String> strList, String str) {
        strList.add(str);
        return strList;
    }
     ...
     */
    public ArrayList<String> removeIngredient(ArrayList<String> strList, String str) {
        strList.remove(str);
        return strList;
    }
