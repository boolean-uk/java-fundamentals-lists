...
public class Exercise extends ExerciseBase {
    ...
    public int getSecondNumber() { return getFavouriteNumbers().get(1); }
    ...
    public ArrayList<Integer> multiply(ArrayList<Integer> arr, int multiplier) {
        arr.replaceAll(e -> e * multiplier);
        return arr;
    }
    ...
    public boolean isEmpty(ArrayList<String> arr) { return arr.isEmpty(); }
    ...
    public ArrayList<String> addIngredient(ArrayList<String> arr, String str) {
        arr.add(str);
        return arr;
    }
    ...
    public ArrayList<String> removeIngredient(ArrayList<String> arr, String str) {
        arr.remove(str);
        return arr;
    }
    ...
    public boolean containsIngredient(ArrayList<String> arr, String ingredient) { return arr.contains(ingredient); }
