...
public class Exercise extends ExerciseBase {
     ...
     */
    public ArrayList<Integer> multiply(ArrayList<Integer> l, int i){
        l.replaceAll(e -> e * i);
        return l;
    }
     ...
     */
    public boolean isEmpty(ArrayList<String> s){
        return s.isEmpty();
    }
     ...
     */
    public ArrayList<String> addIngredient(ArrayList<String> l, String s){
        l.add(s);
        return l;
    }
     ...
     */
    public ArrayList<String> removeIngredient(ArrayList<String> l, String s){
        l.remove(s);
        return l;
    }
     ...
     */
    public boolean containsIngredient(ArrayList<String> l, String s){
        return l.contains(s);
    }
