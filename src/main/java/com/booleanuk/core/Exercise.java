...
public class Exercise extends ExerciseBase {
    ...
    public ArrayList<Integer> multiply(ArrayList<Integer> numList, int multiplier) {
        numList.replaceAll(num -> num * multiplier);
        return numList;
    }
     ...
     */
    public ArrayList<String> addIngredient(ArrayList<String> stringList, String oneString) {
     ...
     */
    public ArrayList<String> removeIngredient(ArrayList<String> stringList, String oneString) {
        stringList.remove(oneString);
        return stringList;
    }
