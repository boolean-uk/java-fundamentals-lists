...
public class Exercise extends ExerciseBase {
     ...
     */
    // The sentence above the link could be taken as an instruction even though it conflicts with the test

    public ArrayList<Integer> multiply(ArrayList<Integer> factors, int factor) {
        ArrayList<Integer> numbers = new ArrayList<>(factors);
        numbers.replaceAll(e -> e * factor);
        return numbers;
