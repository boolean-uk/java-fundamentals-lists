...
public class Exercise extends ExerciseBase {
     ...
     */
    public ArrayList<String> addIngredient(ArrayList<String> strs, String str){
        strs.add(str);
        return strs;
    }
     ...
     */
    public ArrayList<String> removeIngredient(ArrayList<String> strs, String str){
        strs.remove(str);
        return strs;
    }
     ...
     */
    public boolean containsIngredient(ArrayList<String> strs, String str){
