...
public class Exercise extends ExerciseBase {
     ...
     */
        public ArrayList<Integer> multiply (ArrayList<Integer> listNum, int num) {
            listNum.replaceAll(e -> e*num);
            return listNum;
        }
     ...
     */
        ...
        public ArrayList<String> addIngredient(ArrayList<String> listString, String val) {
            listString.add(val);
     ...
     */
    public ArrayList<String> removeIngredient(ArrayList<String> listString, String val) {
        listString.remove(val);
     ...
     */
    public boolean containsIngredient(ArrayList<String> listString, String val) {
        if(listString.contains(val)) {
            return true;
        }
