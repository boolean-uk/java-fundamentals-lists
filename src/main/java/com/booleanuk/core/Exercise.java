...
public class Exercise extends ExerciseBase {
     ...
     */
        ...
        public ArrayList<Integer> multiply(ArrayList<Integer> listOfNumbers, int factor){
            listOfNumbers.replaceAll(nr -> nr * factor);
     ...
     */
        ...
        public ArrayList<String> addIngredient (ArrayList<String> listOfIngredients, String ingredient){
     ...
     */
        ...
        public ArrayList<String> removeIngredient (ArrayList<String> listOfIngredients, String ingredient){
    ...
    public boolean containsIngredient (ArrayList<String> listOfIngredients, String ingredient){
        return listOfIngredients.contains(ingredient);
    }
