...
public class Exercise extends ExerciseBase {
    ...
    public int getSecondNumber() {
        ArrayList<Integer> a = getFavouriteNumbers();
        return a.get(1);
    }
     ...
     */
    public ArrayList<Integer> multiply(ArrayList<Integer> numbers, int numToMultiply) {
        numbers.replaceAll(num -> num*numToMultiply);
        return numbers;
    }
